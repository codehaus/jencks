 ...
 * @version $Rev$ $Date$
 */
public class GeronimoHOWLLog implements TransactionLog {
//    static final byte PREPARE = 1;
    ...
    private static final Log log = LogFactory.getLog(GeronimoHOWLLog.class);
    ...
    public GeronimoHOWLLog(
                   ...
                   XidFactory xidFactory) throws IOException, LogConfigurationException {
